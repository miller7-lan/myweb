...
export const UIOverlay: React.FC = () => {
  ...
  return (
    <div className={`absolute inset-0 pointer-events-none transition-opacity duration-700 ${announcementOpen ? 'z-[140]' : 'z-10'} ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      ...
      {announcementOpen && (
        <div
          className={`announcement-backdrop pointer-events-auto absolute inset-0 z-[150] flex items-start justify-center overflow-y-auto px-4 py-4 sm:items-center ${announcementClosing ? 'is-closing' : 'is-opening'}`}
          role="dialog"
          aria-modal="true"
          aria-label="最近更新公告"
