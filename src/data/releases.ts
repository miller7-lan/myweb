...
export const releases: ReleaseItem[] = [
  ...
  },
  {
    ...
    subtitle: '原生 macOS 菜单栏 / Windows 托盘 Token 统计',
    date: '2026.08 · RELEASE',
    node: 'Node 06',
    icon: ChartNoAxesColumnIncreasing,
    body: '从本机 Codex sessions 日志的实际 usage 中增量统计 Token，在 macOS 菜单栏或 Windows 系统托盘展示今日、当前自然周和当前自然月消耗；Windows 版还可通过本机已登录的 codex app-server 查看实时额度。',
    status: 'Stable',
    platform: 'macOS 13+ · Apple Silicon / Windows 10/11 · x64',
    primaryDownload: {
    ...
    links: [
      {
        label: 'Windows x64 便携版 ZIP (77 MB)',
        href: githubAsset('release-assets/TokenBar_0.1.0_win-x64_portable.zip'),
        sha256: '2ed86f562f44d83c67f84a5cb0f924e2f3f55f0402afa5058bd0cac92ec9c004',
      },
    ],
    specs: [
      { label: '系统', value: 'macOS 13+ / Windows 10/11', icon: Monitor },
      { label: '架构', value: 'Apple Silicon / x64', icon: Cpu },
      { label: '本地存储', value: 'SQLite 增量索引', icon: Database },
      { label: '网络', value: '本地统计无需联网', icon: Network },
    ],
    scenes: [
      ...
      'Windows 实时额度：通过本机已登录的 codex app-server 读取，离线时保留上次成功数据并标记可能已过期。',
      '原生常驻：macOS 不显示 Dock 图标，Windows 不显示任务栏按钮，并默认开启登录后自动启动。',
    ],
    keywords: ['tokenbar', 'codex', 'token', '菜单栏', '系统托盘', '用量统计', '实时额度', '热力图', 'sqlite', 'fsevents', 'macos', 'apple silicon', 'windows', 'win-x64', '便携版', '本地隐私'],
  },
  {
    key: 'next',
    kind: 'software',
